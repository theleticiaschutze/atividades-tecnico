--Criação do banco de dados e usando ele
...
(3, 'Notebook Pro', 'Um poderoso notebook ultrafino.', 1799.99, 'Novo', 'Informatica', '2023-04-10', 10.00),
(4, 'Smartphone Premium', 'Smartphone de alta qualidade.', 999.99, 'Usado', 'Telefonia', '2023-05-19', 20.00),
(5, 'Impressora Laser X1000', 'Uma impressora laser rapida e de alta qualidade.', 399.99, 'Liquidacao', 'Informatica', '2023-03-19', 0.00),
(6, 'Fone de Ouvido Bluetooth Pro', 'Fones de ouvido sem fio com cancelamento de ruido.', 149.99, 'Usado', 'Telefonia', '2023-08-23', 12.00),
...
(10, 'Cafeteira Eletrica 1.5L', 'Uma cafeteira eletrica para preparar cafe fresco.', 49.99, 'Promocao', 'Eletrodomesticos', '2023-09-12', 2.00),
...
--mudando o preço do produto - o update é para mudar e em qual tabela, o set para dizer qual linha/caracteristica e o where para especificar um e não mudar da tabela toda! 
UPDATE produto SET preco = 1500 WHERE id=1;

--Mudando o produto mexendo em mais de um set (linha/caracteristica) 
UPDATE produto SET preco = 2000, tipo='Novo', desconto_usados='0.0' WHERE id=4;

--mais um teste
UPDATE produto SET data_lancamento='2026-03-31' WHERE id=11;

--agora vamos apagar um registro (temos esse produto em varios lugares)
DELETE FROM produto_caracteristica WHERE id=10;
DELETE FROM estoque WHERE id=11 OR id=12;
